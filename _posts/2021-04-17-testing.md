---
layout: page
title: "BleachBit Testing Guide – Developer Documentation"
nav_title: "Testing"
category: dev
...
Test with popular antivirus/security software such as Norton, AVG, McAfee, Avast, and Bit Defender.
Sometimes antivirus software has [false positives which cause errors in BleachBit](https://www.bleachbit.org/forum/074-fails-errors).
...
*   All the requested changes were made. For example, BleachBit 0.7.1 did not delete stored passwords for Firefox 3. See [CleanerML documentation](/cml/cleanerml.html) for advanced instructions on finding more files to clean.
...
[prepared to run BleachBit from source code](/dev/running-from-source-code.html), run
the unit tests with this command:
